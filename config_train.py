...
### XCORR PROCESS ###
#=======================#
xcorr_sections = [(2050, 2250, 2450)] #(start, pivot, end)
...
stack_files_list = ['/home/johannes/THOMAS/0versions_wr/Updated_xcorr_test_ws/workflow_fig/stack_raw_New_500-rand_SNRnew_o_0, dt_0.2, w_2.3, twin_2.6.npz'] #
...
freqs = np.linspace(0.7, 25, int((25-0.7)*xcorr_parameters['wlen']*2))
vels = np.linspace(2*9.6, 2100, int(xcorr_parameters['wlen']*35*3))#1/np.linspace(1/(2*9.6), 1/2100, int(wlen*35*3))
